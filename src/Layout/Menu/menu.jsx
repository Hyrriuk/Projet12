        ...
        <nav className="navbar">
            ...
            <div className="navbar__menu-container">
                <button onClick={handleNavMenuClick} className="navbar__menu-button">
                    Menu
                    {isOpen ? (
                        <FaTimes className="navbar__menu-icon" />
                    ) : (
                        <FaChevronDown className="navbar__menu-icon" />
                    )}
                </button>
                {isOpen && (
                    <nav className="nav_links">
                        <ul>
                            ...
                            <Link activeClass="active" to="abouts" spy={true} smooth={true} offset={0} duration={500}>
                                <li className="nav_links_li">A propos de moi</li>
                            </Link>
                            <a target="_blank" href="https://github.com/Hyrriuk">
                                <li className="nav_links_li">Mon github</li>
                            </a>
                        </ul>
                    </nav>
                )}
